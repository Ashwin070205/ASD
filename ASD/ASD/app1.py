...
if submit and uploaded_image:
    ...
    if final_label == "ASD" and image_confidence > 0.85:

        if age <= 18:
            suggestions = """
    High likelihood of ASD (Early infancy)
    • Start early stimulation activities
    • Encourage eye contact and name response
    • Use simple imitation games
    • Consult developmental pediatrician immediately
    • Begin parent-child interaction therapy
    """

        elif age <= 24:
            suggestions = """
    High likelihood of ASD (Toddler stage)
    • Begin speech therapy evaluation
    • Start structured social play sessions
    • Occupational therapy recommended
    • Encourage pointing and gesture communication
    • Developmental assessment advised
    """

        else:
            suggestions = """
    High likelihood of ASD (Late toddler stage)
    • Comprehensive ASD diagnostic evaluation
    ...
    elif final_label == "ASD":

        if age <= 18:
            suggestions = """
    Moderate ASD indicators
    • Monitor eye contact and response to name
    • Encourage face-to-face interaction
    • Use sensory play activities
    ...
    """
            ...
            suggestions = """
    Moderate ASD indicators
    • Encourage gesture-based communication
    • Increase social play with caregivers
    • Monitor speech development
    • Pediatric developmental consultation recommended
    """

        else:
            suggestions = """
    Moderate ASD indicators
    • Monitor language development closely
    ...
    """
        ...
        if age <= 18:
            suggestions = """
    Development appears typical
    • Encourage bonding and eye contact
    • Talk and sing to child regularly
    • Provide sensory toys
    • Continue milestone monitoring
    """

        elif age <= 24:
            suggestions = """
    No strong ASD indicators
    • Encourage gesture and word usage
    • Interactive play activities
    • Reading picture books together
    • Maintain pediatric check-ups
    """

        else:
            suggestions = """
    Typical developmental signs
    • Encourage social interaction with peers
    • Support language development
    • Structured play routines
    • Continue developmental monitoring
    """
    st.markdown("---")
